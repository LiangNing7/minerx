...
// defaultMinerXFeatureGates consists of all known minerx-specific feature keys.
// To add a new feature, define a key for it above and add it here.
var defaultMinerXFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
