...
HELM_REPO ?= https://market-tke.tencentcloudcr.com/chartrepo/minerx
...
chart.upload.%: chart.package.%  # Upload specified helm chart package.
	@$(HELM) repo add minerx $(HELM_REPO)
	@$(HELM) cm-push --access-token $(ACCESS_TOKEN) $*-$(CHART_VERSION).tgz minerx
