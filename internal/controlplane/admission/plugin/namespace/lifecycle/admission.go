...
import (
	...
	"github.com/LiangNing7/minerx/internal/controlplane/admission/initializer"
)
...
func Register(plugins *admission.Plugins) {
	plugins.Register(PluginName, func(config io.Reader) (admission.Interface, error) {
		return NewLifecycle(sets.New(metav1.NamespaceDefault, metav1.NamespaceSystem, metav1.NamespacePublic))
	})
}
