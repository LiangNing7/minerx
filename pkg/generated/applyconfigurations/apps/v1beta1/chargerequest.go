...
import (
	...
	v1 "github.com/LiangNing7/minerx/pkg/generated/applyconfigurations/meta/v1"
...
func extractChargeRequest(chargeRequest *appsv1beta1.ChargeRequest, fieldManager string, subresource string) (*ChargeRequestApplyConfiguration, error) {
	b := &ChargeRequestApplyConfiguration{}
	err := managedfields.ExtractInto(chargeRequest, internal.Parser().Type("com.github.LiangNing7.minerx.pkg.apis.apps.v1beta1.ChargeRequest"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
