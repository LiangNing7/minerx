...
const file_usercenter_v1_secret_proto_rawDesc = "" +
	"\n" +
	"\x1ausercenter/v1/secret.proto\x12\rusercenter.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb6\x02\n" +
	"\x06Secret\x12\x16\n" +
	...
	"\x06secret\x18\x01 \x01(\v2\x15.usercenter.v1.SecretR\x06secret\"A\n" +
	...
	"\asecrets\x18\x02 \x03(\v2\x15.usercenter.v1.SecretR\asecretsB7Z5github.com/LiangNing7/minerx/pkg/api/usercenter/v1;v1b\x06proto3"

var (
	file_usercenter_v1_secret_proto_rawDescOnce sync.Once
	file_usercenter_v1_secret_proto_rawDescData []byte
)

func file_usercenter_v1_secret_proto_rawDescGZIP() []byte {
	file_usercenter_v1_secret_proto_rawDescOnce.Do(func() {
		file_usercenter_v1_secret_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_usercenter_v1_secret_proto_rawDesc), len(file_usercenter_v1_secret_proto_rawDesc)))
	})
...
func file_usercenter_v1_secret_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_usercenter_v1_secret_proto_rawDesc), len(file_usercenter_v1_secret_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
