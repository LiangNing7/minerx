...
const (
	...
	// MinerControllerDefaultLockObjectName defines default miner controller lock object name ("minerx-miner-controller").
	MinerControllerDefaultLockObjectName = "minerx-miner-controller"
)
