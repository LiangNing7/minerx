...
import (
	...
	controllerconfig "github.com/LiangNing7/minerx/cmd/minerx-blockchain-controller/app/config"
	blockchaincontrollerconfig "github.com/LiangNing7/minerx/internal/controller/blockchain/apis/config"
	"github.com/LiangNing7/minerx/internal/controller/blockchain/apis/config/latest"
	"github.com/LiangNing7/minerx/internal/controller/blockchain/apis/config/validation"
...
const (
	// ControllerUserAgent is the userAgent name when starting minerx-blockchain controller.
	ControllerUserAgent = "minerx-blockchain-controller"
)

// Options is the main context object for the minerx-blockchain controller.
type Options struct {
