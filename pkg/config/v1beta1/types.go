...
const (
	// ControllerManagerDefaultLockObjectNamespace defines default minerx controller manager lock object namespace ("kube-system").
	ControllerManagerDefaultLockObjectNamespace string = metav1.NamespaceSystem

	// ControllerManagerDefaultLockObjectName defines default minerx controller manager lock object name ("minerx-controller-manager").
...
type GenericControllerManagerConfiguration struct {
	...
	// Namespace that the controller watches to reconcile minerx-apiserver objects.
