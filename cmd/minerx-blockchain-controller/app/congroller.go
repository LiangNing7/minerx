...
import (
	...
	"github.com/LiangNing7/minerx/cmd/minerx-blockchain-controller/app/config"
	"github.com/LiangNing7/minerx/cmd/minerx-blockchain-controller/app/options"
	chaincontroller "github.com/LiangNing7/minerx/internal/controller/blockchain/chain"
	minercontroller "github.com/LiangNing7/minerx/internal/controller/blockchain/miner"
	minersetcontroller "github.com/LiangNing7/minerx/internal/controller/blockchain/minerset"
	synccontroller "github.com/LiangNing7/minerx/internal/controller/blockchain/sync"
	resourcecleancontroller "github.com/LiangNing7/minerx/internal/controller/resourceclean"
	"github.com/LiangNing7/minerx/internal/gateway/store"
	"github.com/LiangNing7/minerx/internal/pkg/util/ratelimiter"
	"github.com/LiangNing7/minerx/internal/webhooks"
	"github.com/LiangNing7/minerx/pkg/apis/apps/v1beta1"
	"github.com/LiangNing7/minerx/pkg/apis/apps/v1beta1/index"
...
func NewControllerCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use: "minerx-blockchain-controller",
...
state of the miner through the minerx-apiserver and makes changes attempting to move the
current state towards the desired state.`,
		PersistentPreRunE: func(*cobra.Command, []string) error {
			// silence client-go warnings.
			// minerx-blockchain-controller generically watches APIs (including deprecated ones),
			// and CI ensures it works properly against matching minerx-apiserver versions.
...
func Run(ctx context.Context, c *config.Config) error {
	...
	record.InitFromRecorder(mgr.GetEventRecorderFor("minerx-blockchain-controller"))
