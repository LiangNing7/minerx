...
const (
	...
	// The MinerX project does not currently use this.
...
// Define need status.
// We can directly update the database to the "Need" state to inform minerx-nightwatch of what needs to be done.
// These statuses are only used for operation and maintenance purposes.
const (
	// UserStatusNeedActive informs minerx-nightwatch that the user needs to be activated.
	UserStatusNeedActive = "need_active"
	// UserStatusNeedDisable informs minerx-nightwatch that the user needs to be disabled.
