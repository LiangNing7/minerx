...
import (
	...
	"github.com/LiangNing7/minerx/cmd/minerx-job-controller/app/config"
	"github.com/LiangNing7/minerx/cmd/minerx-job-controller/app/options"
	cronjobcontroller "github.com/LiangNing7/minerx/internal/controller/job/cronjob"
...
current state towards the desired state.`,
		PersistentPreRunE: func(*cobra.Command, []string) error {
			...
			// minerx-job-controller generically watches APIs (including deprecated ones),
