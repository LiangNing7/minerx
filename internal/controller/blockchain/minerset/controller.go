...
import (
	...
	retryutil "github.com/LiangNing7/goutils/pkg/util/retry"

	"github.com/LiangNing7/minerx/internal/pkg/util/annotations"
	"github.com/LiangNing7/minerx/internal/pkg/util/collections"
	"github.com/LiangNing7/minerx/internal/pkg/util/conditions"
	coreutil "github.com/LiangNing7/minerx/internal/pkg/util/core"
	labelsutil "github.com/LiangNing7/minerx/internal/pkg/util/labels"
	logutil "github.com/LiangNing7/minerx/internal/pkg/util/log"
	minerutil "github.com/LiangNing7/minerx/internal/pkg/util/miner"
	"github.com/LiangNing7/minerx/internal/pkg/util/patch"
	"github.com/LiangNing7/minerx/internal/pkg/util/predicates"
	"github.com/LiangNing7/minerx/internal/pkg/util/ssa"
...
// Reconcile reads that state of the MinerX for a MinerSet object and makes changes based on the state read
...
func (r *Reconciler) syncReplicas(ctx context.Context, ms *v1beta1.MinerSet, miners []*v1beta1.Miner) (ctrl.Result, error) {
	...
	case diff > 0:
		...
		// In order to reduce the pressure on the minerx-apiserver, for each minerset,
...
// Otherwise fields would be co-owned by our "old" "manager" and "minerx-minerset" and then we would not be
