...
//go:generate mockgen -destination mock_secret.go -package secret minerx/internal/usercenter/biz/v1/secret SecretBiz
...
func (b *secretBiz) Update(ctx context.Context, rq *v1.UpdateSecretRequest) (*v1.UpdateSecretResponse, error) {
	...
	if rq.Expires != nil {
		secretM.Expires = rq.GetExpires()
	}
	if rq.Status != nil {
		secretM.Status = rq.GetStatus()
	}
	if rq.Description != nil {
		secretM.Description = rq.GetDescription()
	}
