...
const file_cacheserver_v1_secret_proto_rawDesc = "" +
	"\n" +
	"\x1bcacheserver/v1/secret.proto\x12\x0ecacheserver.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\"\xb3\x01\n" +
	"\x10SetSecretRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x1e\n" +
	"\x04name\x18\x02 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\xfd\x01R\x04name\x126\n" +
	"\x06expire\x18\x03 \x01(\v2\x19.google.protobuf.DurationH\x00R\x06expire\x88\x01\x01\x12*\n" +
	"\vdescription\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x02R\vdescriptionB\t\n" +
	"\a_expire\"$\n" +
	...
	"\tupdatedAt\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAtB8Z6github.com/LiangNing7/minerx/pkg/api/cacheserver/v1;v1b\x06proto3"
