...
import (
	...
	"github.com/LiangNing7/minerx/internal/nightwatch/model"
	"github.com/LiangNing7/minerx/internal/nightwatch/pkg/path"
	fakeminio "github.com/LiangNing7/minerx/internal/pkg/client/minio/fake"
	"github.com/LiangNing7/minerx/internal/pkg/client/train"
	known "github.com/LiangNing7/minerx/internal/pkg/known/nightwatch"
	jobconditionsutil "github.com/LiangNing7/minerx/internal/pkg/util/jobconditions"
	v1 "github.com/LiangNing7/minerx/pkg/api/nightwatch/v1"
)
...
func (sm *StateMachine) Embedding(ctx context.Context, event *fsm.Event) error {
	...
	/*
		var typedEmbedder minerxembedder.Embedder
		switch EmbedderType {
		case minerxxembedder.TextEmbeddingType:
			typedEmbedder = text.NewEmbedder(llm)
		case minerxembedder.ImageEmbeddingType:
			typedEmbedder = image.NewEmbedder(llm)
		default:
		}
		// Create a new embedder with rate limiting
		embedder := minerxembedder.NewEmbedder(typedEmbedder, minerxembedder.WithRateLimiter(sm.Watcher.Limiter.Embedding))
