...
import (
	...
	"github.com/LiangNing7/minerx/internal/pkg/options"
)
...
func NewOptions() *Options {
	o := &Options{
		...
		AlternateDNS:            []string{"liangning7.cn"},
	...
	*/
	...
	o.RecommendedOptions.CoreAPI.CoreAPIKubeconfigPath = "$HOME/.minerx/config"
	if cfg := os.Getenv("MINERXCONFIG"); cfg != "" {
		o.RecommendedOptions.CoreAPI.CoreAPIKubeconfigPath = cfg
	}
	// We only register the plugin of minerx-apiserver,
	...
	// register all custom admission plugins
