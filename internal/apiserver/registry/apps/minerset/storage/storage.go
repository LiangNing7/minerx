...
import (
	...
	"github.com/LiangNing7/minerx/internal/apiserver/registry/apps/minerset"
	printersinternal "github.com/LiangNing7/minerx/internal/pkg/printers/internalversion"
...
var replicasPathInMinerSet = managedfields.ResourcePathMappings{
	schema.GroupVersion{Group: "apps.liangning7.cn", Version: "v1beta1"}.String(): fieldpath.MakePathOrDie("spec", "replicas"),
}
...
func (i *scaleUpdatedObjectInfo) UpdatedObject(ctx context.Context, oldObj runtime.Object) (runtime.Object, error) {
	...
	groupVersion := schema.GroupVersion{Group: "apps.liangning7.cn", Version: "v1beta1"}
