...
_install.cfssl: ## Install cfssl toolkit.
	@$(SCRIPTS_DIR)/install.sh minerx::install::install_cfssl

.PHONY: _install.addlicense
_install.addlicense: ## Install addlicense.
	@$(GO) install github.com/LiangNing7/goutils/addlicense@$(ADDLICENSE_VERSION)
...
_install.grpc:
	...
	@$(GO) install github.com/onexstack/protoc-gen-defaults@$(PROTOC_GEN_DEFAULT) 
...
# db2struct --gorm --json -H 127.0.0.1 -d minerx -t secret --package model --struct SecretM -u gateway -p 'proj(#)666' --target=secret.go
