...
copyright.verify: tools.verify.addlicense ## Verify the boilerplate headers for all files.
	...
	@addlicense --check -f $(SCRIPTS_DIR)/boilerplate/boilerplate.txt $(PROJ_ROOT_DIR) --skip-dirs=third_party,vendor,_output

.PHONY: copyright.add
copyright.add: tools.verify.addlicense ## Add boilerplate headers for all missing files.
	@addlicense -v -f $(SCRIPTS_DIR)/boilerplate/boilerplate.txt $(PROJ_ROOT_DIR) --skip-dirs=third_party,vendor,_output
