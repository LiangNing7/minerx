...
// CleanReconciler is a struct that represents a set of cleaners used to clean deleted resources from minerx db.
type CleanReconciler struct {
	cleaners []Cleaner
}

// NewCleanReconciler return a cleaner set used to clean deleted resources from minerx db.
