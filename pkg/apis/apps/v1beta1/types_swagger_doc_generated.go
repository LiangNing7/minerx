...
var map_ChainSpec = map[string]string{
	...
	"bootstrapAccount":       "Default bootstrap MinerX's Genesis account with 1M TBB tokens. This field is automatic generated by MinerX, you should not set this field.",
}
