...
import (
	...
	controllerconfig "github.com/LiangNing7/minerx/cmd/minerx-job-controller/app/config"
	jobcontrollerconfig "github.com/LiangNing7/minerx/internal/controller/job/apis/config"
	"github.com/LiangNing7/minerx/internal/controller/job/apis/config/latest"
	"github.com/LiangNing7/minerx/internal/controller/job/apis/config/validation"
...
const (
	// ControllerUserAgent is the userAgent name when starting minerx-job controller.
	ControllerUserAgent = "minerx-job-controller"
)

// Options is the main context object for the minerx-job-controller.
type Options struct {
