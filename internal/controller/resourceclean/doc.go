// Package resourceclean is used to delete resoures from database which is already deleted from minerx-apiserver.

// Sometimes resources are deleted from the minerx-apiserver, but due to reasons such as deployments,
...
package resourceclean // import "github.com/LiangNing7/minerx/internal/controller/resourceclean"
