...
var (
	...
	username   = pflag.StringP("username", "u", "minerx", "Username to connect to the database.")
	password   = pflag.StringP("password", "p", "minerx(#)666", "Password to use when connecting to the database.")
	database   = pflag.StringP("db", "d", "minerx", "Database name to connect to.")
