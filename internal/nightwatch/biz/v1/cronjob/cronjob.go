...
//go:generate mockgen -destination mock_cronjob.go -package cronjob minerx/internal/nightwatch/biz/v1/cronjob CronJobBiz
...
import (
	...
	"github.com/LiangNing7/minerx/internal/nightwatch/pkg/conversion"
