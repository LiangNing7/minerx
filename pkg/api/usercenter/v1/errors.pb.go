...
const file_usercenter_v1_errors_proto_rawDesc = "" +
	"\n" +
	"\x1ausercenter/v1/errors.proto\x12\rusercenter.v1\x1a\x13errors/errors.proto*\xf8\x01\n" +
	...
	"\x12SecretCreateFailed\x10\a\x1a\x04\xa8E\x9d\x04\x1a\x04\xa0E\xf4\x03B7Z5github.com/LiangNing7/minerx/pkg/api/usercenter/v1;v1b\x06proto3"

var (
	file_usercenter_v1_errors_proto_rawDescOnce sync.Once
	file_usercenter_v1_errors_proto_rawDescData []byte
)

func file_usercenter_v1_errors_proto_rawDescGZIP() []byte {
	file_usercenter_v1_errors_proto_rawDescOnce.Do(func() {
		file_usercenter_v1_errors_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_usercenter_v1_errors_proto_rawDesc), len(file_usercenter_v1_errors_proto_rawDesc)))
	})
...
func file_usercenter_v1_errors_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_usercenter_v1_errors_proto_rawDesc), len(file_usercenter_v1_errors_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
